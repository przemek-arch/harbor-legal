...
var SITE = {
  ...
  services: {
    ...
    en: {
      'tech-fintech': [
        { num: '01', anchor: 'fintech', name: 'Fintech & Payments', desc: 'Licensing of payment institutions and EMIs, building PSD2/PSD3-compliant systems, AML/KYC procedures, VASP registration and MiCA compliance. I guide fintechs through the entire regulatory process \u2014 from KNF application to ongoing supervision.', tags: 'PSD2/3 \u00b7 AML/KYC \u00b7 KNF \u00b7 MiCA \u00b7 EMI', details: ['KIP/MIP license applications to KNF', 'AML/KYC procedures compliant with anti-money laundering regulations', 'VASP registration and MiCA transition for crypto-asset providers', 'PSD2/PSD3 compliance: SCA, open banking, agent agreements', 'Outsourcing agreements with critical service providers'] },
        { num: '02', anchor: 'startup', name: 'Startup & Scale-up', desc: 'Legal structuring from pre-seed through Series A+ to exit. I prepare cap tables, ESOP plans, SHA agreements and coordinate legal due diligence. I know investor expectations because I have sat on both sides of the table.', tags: 'VC/PE \u00b7 ESOP \u00b7 SHA \u00b7 Cap table \u00b7 Exit', details: ['Cap table structuring and shareholder agreements (SHA)', 'ESOP/VSOP plans for key employees', 'VC/PE transaction documentation: term sheet, SPA, side letters', 'Legal due diligence \u2014 buy-side and sell-side', 'Corporate governance for portfolio companies'] },
        { num: '03', anchor: 'gdpr', name: 'GDPR & Data Protection', desc: 'Compliance audits, processing documentation (RoPA, DPIA), processor agreements, Data Protection Officer support and representation before UODO. I implement GDPR pragmatically \u2014 protecting your business, not blocking it.', tags: 'GDPR \u00b7 DPIA \u00b7 RoPA \u00b7 DPO \u00b7 UODO', details: ['GDPR compliance audits and gap analysis', 'Records of Processing Activities (RoPA) and DPIA', 'Controller-processor agreements and SCCs for data transfers', 'DPO-as-a-service and UODO representation', 'Privacy by design implementation in products'] },
        { num: '04', anchor: 'regulacje-tech', name: 'Tech Regulations', desc: 'DSA, DMA, AI Act, Data Act, eIDAS \u2014 the new EU regulatory framework for technology companies. I help you understand which obligations apply and how to implement them without slowing down your product roadmap.', tags: 'DSA \u00b7 DMA \u00b7 AI Act \u00b7 eIDAS \u00b7 Data Act', details: ['DSA compliance: content moderation, transparency reports', 'DMA obligations for gatekeepers and business users', 'AI Act: risk classification and GPAI obligations', 'Data Act: data sharing and cloud switching provisions', 'eIDAS 2.0: digital identity and trust services'] },
        { num: '05', anchor: 'ma', name: 'M&A & Restructuring', desc: 'Full legal support for mergers, acquisitions, spin-offs and corporate restructuring. From LOI through due diligence to SPA and post-closing integration. Experience with cross-border transactions.', tags: 'M&A \u00b7 Due diligence \u00b7 SPA \u00b7 PMI \u00b7 Restructuring', details: ['LOI/Term sheet negotiation and structuring', 'Legal due diligence: full scope and red flag', 'SPA drafting and negotiation, W&I provisions', 'Post-merger integration (PMI): corporate and contractual', 'Restructuring, mergers and de-mergers under KSH'] },
        { num: '06', anchor: 'cross-border', name: 'Cross-border', desc: 'International transactions, multi-jurisdictional contract structures and regulatory coordination. I work with local partners in the EEA, Hong Kong, UAE and Cyprus. Single point of contact for the entire engagement.', tags: 'EEA \u00b7 Hong Kong \u00b7 UAE \u00b7 Cyprus \u00b7 International', details: ['Cross-border commercial contracts (choice of law, jurisdiction)', 'International holding and SPV structures', 'Regulatory coordination across jurisdictions', 'Transfer pricing and IP arrangements', 'Network of local law firms in 9+ countries'] }
      ],
      'obsluga-firm': [
        { num: '01', anchor: 'umowy', name: 'Commercial Contracts', desc: 'I draft, negotiate and review commercial, framework, distribution, NDA and SLA agreements. I create contract templates and T&Cs tailored to your business model \u2014 so you don\u2019t have to start from scratch every time.', tags: 'Drafting \u00b7 Negotiation \u00b7 NDA \u00b7 T&Cs \u00b7 GTC', details: ['Drafting and negotiation of commercial and framework agreements', 'NDA, SLA, GTC, service terms and conditions', 'Building a contract template library', 'Contract review and redlining', 'Framework and distribution agreements'] },
        { num: '02', anchor: 'korporacyjne', name: 'Corporate Governance', desc: 'KRS proceedings, general meeting resolutions, amendments to articles of association, board changes and ongoing KRS reporting. I handle corporate paperwork so that you can focus on running your business.', tags: 'KRS \u00b7 Resolutions \u00b7 Articles \u00b7 Board \u00b7 Governance', details: ['KRS registration and amendments', 'Preparation of resolutions and corporate documentation', 'Amendments to articles of association', 'Share capital increases and contributions in kind', 'Board and supervisory board changes'] },
        { num: '03', anchor: 'prawo-pracy', name: 'Employment Law', desc: 'Employment and B2B contracts, workplace regulations, non-compete and confidentiality clauses, disciplinary dismissals and labor court disputes. I protect employers while maintaining good relations with teams.', tags: 'Employment \u00b7 B2B \u00b7 Non-compete \u00b7 Dismissal \u00b7 Labor court', details: ['Employment and B2B/contractor agreements', 'Workplace regulations and remote work policies', 'Non-compete and confidentiality clauses', 'Disciplinary procedures and dismissal documentation', 'Representation in labor disputes and mediation'] },
        { num: '04', anchor: 'compliance', name: 'Compliance & Risk', desc: 'Building and auditing compliance management systems: AML, whistleblower protection, anti-corruption, ESG and internal policies. I tailor compliance to your company\u2019s scale \u2014 pragmatically, without unnecessary bureaucracy.', tags: 'AML \u00b7 Whistleblower \u00b7 ESG \u00b7 Procedures \u00b7 Audit', details: ['AML/CFT compliance: procedures, training, audits', 'Whistleblower protection system implementation', 'Anti-corruption and gift policies', 'ESG and sustainability reporting', 'Internal compliance audits and risk mapping'] },
        { num: '05', anchor: 'windykacja', name: 'Debt Recovery', desc: 'Pre-litigation debt recovery, payment orders, enforcement proceedings and creditor representation in restructuring and bankruptcy. I recover debts effectively \u2014 by negotiation first, in court when necessary.', tags: 'Payment order \u00b7 Enforcement \u00b7 Bankruptcy \u00b7 Restructuring', details: ['Pre-litigation collection: demands and negotiation', 'Payment order and writ of payment proceedings', 'Bailiff enforcement and asset tracing', 'Creditor representation in restructuring and bankruptcy', 'Challenging debtor\u2019s dispositive actions (actio pauliana)'] }
      ],
      'spory': [
        { num: '01', anchor: 'spory-gosp', name: 'Commercial Disputes', desc: 'I represent clients in contractual, payment, damages and corporate disputes before common courts at all instances. I build litigation strategy focused on results \u2014 not on multiplying filings.', tags: 'Contractual \u00b7 Damages \u00b7 Corporate \u00b7 Appeal', details: ['Contractual disputes: breach of contract, penalties, termination', 'Payment claims and damages actions', 'Corporate disputes: challenging resolutions, board liability', 'Appeal and cassation proceedings', 'Settlement negotiations at every stage'] },
        { num: '02', anchor: 'arbitraz', name: 'Arbitration & Mediation', desc: 'I conduct domestic arbitration (SA KIG, Lewiatan), international proceedings and commercial mediation. Arbitration is often faster and more confidential than court \u2014 I advise when it\u2019s worth choosing.', tags: 'SA KIG \u00b7 Lewiatan \u00b7 ICC \u00b7 Mediation \u00b7 ADR', details: ['Domestic arbitration: SA KIG, Lewiatan Arbitration Court', 'International arbitration: ICC, LCIA, ad hoc', 'Commercial mediation and conciliation', 'Drafting arbitration clauses in contracts', 'Recognition and enforcement of arbitral awards'] },
        { num: '03', anchor: 'regulacyjne', name: 'Regulatory Proceedings', desc: 'I represent clients before KNF, UOKiK, UODO and GIIF \u2014 from inspections and investigations to appeals against administrative decisions. I help minimize the risk of sanctions and financial penalties.', tags: 'KNF \u00b7 UOKiK \u00b7 UODO \u00b7 GIIF \u00b7 Appeals', details: ['Representation before KNF: inspections, supervisory proceedings', 'UOKiK proceedings: anti-competitive practices, unfair clauses', 'UODO proceedings: GDPR violations, inspections', 'GIIF proceedings: AML/CFT, account freezes', 'Appeals against administrative decisions, complaints to WSA/NSA'] }
      ]
    }
  },
