...
var SITE = {
  ...
  services: {
    pl: {
      'tech-fintech': [
        { num: '01', name: 'Fintech & Płatności', desc: 'Licencjonowanie instytucji płatniczych i\u00a0EMI, budowanie systemów zgodnych z\u00a0PSD2/PSD3, wdrażanie procedur AML/KYC, rejestracja VASP i\u00a0compliance MiCA. Przeprowadzam fintechy przez cały proces regulacyjny — od wniosku do KNF po bieżący nadzór.', tags: 'PSD2/3 \u00b7 AML/KYC \u00b7 KNF \u00b7 MiCA \u00b7 EMI' },
        { num: '02', name: 'Startup & Scale-up', desc: 'Obsługa prawna od incorporacji przez rundy finansowania VC po exit. Przygotowuję umowy inwestycyjne (SHA, term sheet), programy ESOP i\u00a0struktury corporate governance, które skalują się razem z\u00a0firmą.', tags: 'SHA \u00b7 ESOP \u00b7 VC \u00b7 M&A \u00b7 Cap Table' },
        { num: '03', name: 'Ochrona danych', desc: 'Kompleksowe wdrożenia GDPR: polityki prywatności, umowy powierzenia, DPIA, procedury naruszeń danych, szkolenia zespołów. Oferuję też DPO as a\u00a0Service — pełnię funkcję inspektora ochrony danych bez obciążania Twojego budżetu etatem.', tags: 'GDPR \u00b7 DPIA \u00b7 DPO \u00b7 Cookie Policy \u00b7 Szkolenia' },
        { num: '04', name: 'Transakcje M&A', desc: 'Due diligence prawne, strukturyzacja transakcji, negocjacje SPA/APA, reorganizacje korporacyjne i\u00a0post-merger integration. Prowadzę transakcje od first look po closing — z\u00a0dbałością o\u00a0detale, które chronią Twoje interesy.', tags: 'SPA \u00b7 APA \u00b7 Due Diligence \u00b7 Closing \u00b7 PMI' },
        { num: '05', name: 'Regulacje Tech', desc: 'Compliance z\u00a0AI Act, DSA/DMA, regulacje platform marketplace i\u00a0e-commerce, umowy SaaS i\u00a0licencje software. Pomagam firmom technologicznym działać zgodnie z\u00a0regulacjami, zanim te staną się problemem.', tags: 'AI Act \u00b7 DSA \u00b7 DMA \u00b7 SaaS \u00b7 E-commerce' },
        { num: '06', name: 'Cross-Border', desc: 'Obsługa transgraniczna w\u00a0EOG, ZEA i\u00a0Hongkongu. Kontrakty międzynarodowe, structuring, wybór jurysdykcji i\u00a0koordynacja z\u00a0siecią lokalnych kancelarii partnerskich — jeden punkt kontaktowy dla operacji w\u00a0wielu krajach.', tags: 'EOG \u00b7 ZEA \u00b7 Hongkong \u00b7 Structuring' },
      ],
      'obsluga-firm': [
        { num: '01', name: 'Umowy handlowe', desc: 'Przygotowuję, negocjuję i\u00a0weryfikuję umowy handlowe, ramowe, dystrybucyjne, NDA i\u00a0SLA. Tworzę wzorce umowne i\u00a0regulaminy dopasowane do Twojego modelu biznesowego — tak, żebyś nie musiał za każdym razem zaczynać od zera.', tags: 'Drafting \u00b7 Negocjacje \u00b7 NDA \u00b7 Regulaminy \u00b7 OWH' },
        { num: '02', name: 'Prawo pracy', desc: 'Kompleksowa obsługa kadrowo-prawna: umowy o\u00a0pracę, kontrakty B2B, regulaminy pracy i\u00a0wynagradzania, zwolnienia indywidualne i\u00a0grupowe. Doradzam też w\u00a0sporach pracowniczych i\u00a0przed PIP, zanim eskalują do sądu.', tags: 'KP \u00b7 B2B \u00b7 Regulaminy \u00b7 Zwolnienia \u00b7 PIP' },
        { num: '03', name: 'Prawo korporacyjne', desc: 'Bieżąca obsługa KRS, przygotowanie zgromadzeń wspólników i\u00a0uchwał, zmiany umowy spółki, podwyższenia kapitału, przekształcenia. Pilnuję formalności, żebyś Ty mógł skupić się na biznesie.', tags: 'KRS \u00b7 Uchwały \u00b7 Kapitał \u00b7 Governance \u00b7 Przekształcenia' },
        { num: '04', name: 'Compliance', desc: 'Wdrożenia AML/CFT, procedury whistleblowing, polityki antykorupcyjne, audyty zgodności i\u00a0szkolenia zespołów. Buduję systemy compliance, które działają w\u00a0praktyce — nie tylko na papierze.', tags: 'AML \u00b7 Whistleblowing \u00b7 Audyt \u00b7 Szkolenia' },
        { num: '05', name: 'Windykacja', desc: 'Windykacja przedsądowa i\u00a0sądowa, wezwania do zapłaty, zabezpieczenie roszczeń, postępowania nakazowe i\u00a0egzekucyjne. Odzyskuję należności skutecznie, minimalizując koszty i\u00a0czas.', tags: 'Przedsądowa \u00b7 Nakazowe \u00b7 Egzekucja \u00b7 Zabezpieczenie' },
      ],
      'spory': [
        { num: '01', name: 'Spory gospodarcze', desc: 'Reprezentuję klientów w\u00a0sporach kontraktowych, o\u00a0zapłatę, odszkodowawczych i\u00a0korporacyjnych przed sądami powszechnymi wszystkich instancji. Buduję strategię procesową nastawioną na wynik — nie na mnożenie pism.', tags: 'Kontraktowe \u00b7 Odszkodowania \u00b7 Korporacyjne \u00b7 Apelacja' },
        { num: '02', name: 'Arbitraż & mediacje', desc: 'Prowadzę postępowania arbitrażowe krajowe (SA KIG, Lewiatan) i\u00a0międzynarodowe oraz mediacje gospodarcze. Arbitraż to często szybsza i\u00a0bardziej poufna alternatywa dla sądu — doradzam, kiedy warto z\u00a0niej skorzystać.', tags: 'SA KIG \u00b7 Lewiatan \u00b7 ICC \u00b7 Mediacja \u00b7 ADR' },
        { num: '03', name: 'Postępowania regulacyjne', desc: 'Reprezentuję klientów przed KNF, UOKiK, UODO i\u00a0GIIF — od kontroli i\u00a0postępowań wyjaśniających po odwołania od decyzji administracyjnych. Pomagam minimalizować ryzyko sankcji i\u00a0kar finansowych.', tags: 'KNF \u00b7 UOKiK \u00b7 UODO \u00b7 GIIF \u00b7 Odwołania' },
      ]
    },
    en: {} // Phase 3
  },
